...
/* ─────────────────────────────────────────────────────────
   Crossfade hook — alternates two background art layers
   so colour transitions are smooth (1 second fade)
───────────────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────────────
   Lyrics panel — used on both mobile and desktop
───────────────────────────────────────────────────────── */
...
export function Player() {
  ...
  useEffect(() => {
    ...
    } catch { /* silent — AudioContext before user gesture */ }
  ...
  /* ─── Auto-fetch lyrics when full-screen opens ─────── */
  useEffect(() => {
  ...
  /* ─── Parse lyrics — Array.isArray safe ────────────── */
  ...
  return (
    <>
      ...
      >
        {/* ── Dynamic background — crossfade artwork layers ── */}
        ...
        {/* ── Top bar (shared for mobile + desktop) ── */}
        ...
        {/* ══════════════════════════════════════════════
            BODY — single column on mobile, two on desktop
        ══════════════════════════════════════════════ */}
        <div className="flex-1 flex overflow-hidden">

          {/* ── LEFT PANEL ─────────────────────────────
              Mobile: full width + scrollable
              Desktop: fixed-width column (no scroll)
          ─────────────────────────────────────────── */}
          <div className="flex flex-col w-full md:w-[420px] lg:w-[460px] flex-shrink-0 overflow-y-auto md:overflow-y-visible md:justify-center px-8 pb-6 md:pb-0">
            ...
            {/* ── MOBILE ONLY: lyrics appear below controls ── */}
          ...
          {/* ── RIGHT PANEL — LYRICS (desktop only) ────────
              Full height, scrollable, with backdrop blur card
          ─────────────────────────────────────────────── */}
